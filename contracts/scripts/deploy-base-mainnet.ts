...
async function main() {
  ...
  // Set up chain bridges for Base mainnet
  ...
  console.log("✅ Chain bridges configured for Base mainnet");
  ...
  console.log("\n⚠️  IMPORTANT: This is deployed to Base Mainnet!");
  console.log("   - Ensure you have sufficient ETH for gas fees");
...
main()
  .then(() => process.exit(0))
  .catch((error) => {
    console.error("❌ Base Mainnet deployment failed:", error);
    process.exit(1);
  }); 