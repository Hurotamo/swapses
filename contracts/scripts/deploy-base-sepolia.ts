...
async function main() {
  ...
  // Set up chain bridges for Base Sepolia testnet
  ...
  console.log("✅ Chain bridges configured for Base Sepolia testnet");
  ...
  console.log("\n⚠️  IMPORTANT: This is deployed to Base Sepolia Testnet!");
  console.log("   - This is a testnet - use test tokens only");
  console.log("   - Get test ETH from Base Sepolia faucet");
